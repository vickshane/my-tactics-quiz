...
def main():
    ...
    if st.session_state.test_questions:
        ...
        with st.sidebar:
            ...
            # 將 TOP 與 END 結合在這裡，並做成並排的漂亮按鈕
            st.markdown("""
            <div style="display: flex; gap: 10px; margin-bottom: 15px;">
                <a href="#nav-settings" style="flex: 1; text-align: center; padding: 10px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 8px; font-weight: bold;">🔼 TOP</a>
                <a href="#nav-end" style="flex: 1; text-align: center; padding: 10px; background-color: #FF9800; color: white; text-decoration: none; border-radius: 8px; font-weight: bold;">🔽 END</a>
            </div>
            """, unsafe_allow_html=True)

            # 如果是在全部顯示模式，就加上「輸入題號跳轉」功能
